...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0' => 'get1Ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0Service',
            '2_ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0' => 'get2Ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0Service',
            ...
            'oc_user.security.email_authenticator' => 'getOcUser_Security_EmailAuthenticatorService',
            ...
            'security.user.provider.concrete.oc_user' => 'getSecurity_User_Provider_Concrete_OcUserService',
        ...
        $this->privates = array(
            '1_ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0' => true,
            '2_ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0' => true,
            ...
            'security.user.provider.concrete.oc_user' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0']) ? $this->services['1_ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0'] : $this->get1Ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0']) ? $this->services['2_ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0'] : $this->get2Ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'blog', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/OC/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/OC/BlogBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'OC\\UserBundle\\Entity');
        $c->addDriver($b, 'OC\\BlogBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('OCUserBundle' => 'OC\\UserBundle\\Entity', 'OCBlogBundle' => 'OC\\BlogBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8f1f449a8eeee6a6037e1e33cbabcb0c88c9129d757c7b558d88f592e6e4fd86');
    ...
    /**
     * Gets the 'oc_user.security.email_authenticator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\UserBundle\Security\EmailAuthenticator A OC\UserBundle\Security\EmailAuthenticator instance
     */
    protected function getOcUser_Security_EmailAuthenticatorService()
    {
        return $this->services['oc_user.security.email_authenticator'] = new \OC\UserBundle\Security\EmailAuthenticator(${($_ = isset($this->services['router']) ? $this->services['router'] : $this->get('router')) && false ?: '_'}, ${($_ = isset($this->services['security.password_encoder']) ? $this->services['security.password_encoder'] : $this->get('security.password_encoder')) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('OC\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $c = ${($_ = isset($this->services['security.user.provider.concrete.oc_user']) ? $this->services['security.user.provider.concrete.oc_user'] : $this->getSecurity_User_Provider_Concrete_OcUserService()) && false ?: '_'};
        ...
        $i->add($h, array(0 => 'IS_AUTHENTICATED_REMEMBERED'), NULL);

        $j = new \Symfony\Component\Security\Http\HttpUtils($f, $f);

        $k = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '8536d0105423f4566a70e5b479376add022c9f4d', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $l = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $j, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($j, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        $l->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $l->addHandler($k);

        $m = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener(${($_ = isset($this->services['security.authentication.guard_handler']) ? $this->services['security.authentication.guard_handler'] : $this->get('security.authentication.guard_handler')) && false ?: '_'}, $g, 'main', new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['oc_user.security.email_authenticator']) ? $this->services['oc_user.security.email_authenticator'] : $this->get('oc_user.security.email_authenticator')) && false ?: '_'};
        }, 1), $a);
        $m->setRememberMeServices($k);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'main', $a, $d, $e), 2 => $l, 3 => $m, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $k, $g, $a, $d, true, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate')), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '595ce7dc947d76.26319333', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, $i, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $e, $j, 'main', ${($_ = isset($this->services['oc_user.security.email_authenticator']) ? $this->services['oc_user.security.email_authenticator'] : $this->get('oc_user.security.email_authenticator')) && false ?: '_'}, NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', NULL, true, false, 'security.user.provider.concrete.oc_user', 'main', 'oc_user.security.email_authenticator', NULL, NULL, array(0 => 'logout', 1 => 'guard', 2 => 'remember_me', 3 => 'anonymous')));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/OC/BlogBundle/Resources/views'), 'OCBlog');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('8536d0105423f4566a70e5b479376add022c9f4d');
    }
    ...
    /**
     * Gets the '1_ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get1Ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0Service()
    {
        return $this->services['1_ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get2Ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0Service()
    {
        return $this->services['2_ff404a85de9383815f5d55f860c00c6970d103258d6ab7d1f4a8a4395cf35ab0'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('XjJzvtZBCA', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('12ovzfuwd6', 0, 'rtYKn+-sELpS26Rb8N7tq+', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mrzW-8GSgR', 0, 'rtYKn+-sELpS26Rb8N7tq+', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Zw3oNpGS67', 0, 'rtYKn+-sELpS26Rb8N7tq+', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('595ce7dc947d76.26319333');
    }
    ...
    protected function getSecurity_Authentication_Provider_Guard_MainService()
    {
        return $this->services['security.authentication.provider.guard.main'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['oc_user.security.email_authenticator']) ? $this->services['oc_user.security.email_authenticator'] : $this->get('oc_user.security.email_authenticator')) && false ?: '_'};
        }, 1), ${($_ = isset($this->services['security.user.provider.concrete.oc_user']) ? $this->services['security.user.provider.concrete.oc_user'] : $this->getSecurity_User_Provider_Concrete_OcUserService()) && false ?: '_'}, 'main', ${($_ = isset($this->services['security.user_checker']) ? $this->services['security.user_checker'] : $this->getSecurity_UserCheckerService()) && false ?: '_'});
    }
    ...
    /**
     * Gets the 'security.user.provider.concrete.oc_user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_OcUserService()
    {
        return $this->services['security.user.provider.concrete.oc_user'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->get('doctrine')) && false ?: '_'}, 'OCUserBundle:User', 'email', NULL);
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'OCBlogBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/OC/BlogBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'OCBlogBundle' => 'OC\\BlogBundle\\OCBlogBundle',
            ...
            'secret' => '8536d0105423f4566a70e5b479376add022c9f4d',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '8536d0105423f4566a70e5b479376add022c9f4d',
